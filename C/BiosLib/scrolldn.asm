...
;*****************************************************************************;
;									      ;
;   File name	    SCROLLDN.ASM					      ;
;									      ;
;   Description     Routine to scroll the display down			      ;
;									      ;
...
;=============================================================================;
;
;  ENTRY POINT NAME:	scrolldown
;
;  DESCRIPTION: 	Scroll a horizontal band of the display down
;
;  INPUT PARAMETERS
