...
/* XXXX_SOURCE macros, defining what flavor of Unix the program is written for */

#ifndef __FreeBSD__		/* Contrary to the others, FreeBSD is substractive. It defines everything by default. */
...
/* Other extension definition control macros */
