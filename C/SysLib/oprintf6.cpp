/*****************************************************************************\
*                                                                             *
*   File name:	    oprintf6.cpp					      *
*                                                                             *
*   Description:    Generalized C++ object formatting - 6-argument option     *
*                                                                             *
*   Notes:                                                                    *
*                                                                             *
*   History:								      *
...
int CDECL oprintf(const char *pszForm, OPFA oa0, OPFA oa1, OPFA oa2, OPFA oa3, OPFA oa4, OPFA oa5)
    ...
    poaList[5] = &oa5;
#endif
    return ovprintf(pszForm, poaList, 6);
    }
...
int CDECL osnprintf(char *pszBuf, size_t iSize, const char *pszForm, OPFA oa0, OPFA oa1, OPFA oa2, OPFA oa3, OPFA oa4, OPFA oa5)
    ...
    poaList[5] = &oa5;
#endif
    return ovsnprintf(pszBuf, iSize, pszForm, poaList, 6);
    }
