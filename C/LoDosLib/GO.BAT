...
:#  Filename:	    go.bat						      *
:#                                                                            *
:#  Description:    Build the lodos.lib library				      *
:#                                                                            *
...
:#                                                                            *
:#  History:                                                                  *
:#   2001-06-11 JFL Use VC++ 6.0 nmake instead of VC++ 5.                     *
...
SET BIOSLIB=C:\SRC\LIBS\BIOSLIB

echo.
%NMAKE% %1 %2 %3 %4 %5 /f lodoslib.mak /x - >lodoslib.log
echo.
type lodoslib.log
