...
#   File name	    camel.tcl                                        	      #
#                                                                             #
#   Description     Convert strings to camel case                             #
#                                                                             #
#   Notes	    For use in pipes. Ex: 1clip | camel | 2clip               #
#                                                                             #
#   History								      #
...
proc ToCamel {string} {
    subst -nobackslashes -novariables [regsub -all {\S+} $string {[string totitle &]}]
}
