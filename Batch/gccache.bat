...
:#----------------------------------------------------------------------------#
:#                                                                            #
:#  File name       gccache.bat                                               #
:#                                                                            #
:#  Description     Find big files in Google Chrome cache                     #
:#                                                                            #
...
if exist   "%LOCALAPPDATA%\Google\Chrome\User Data\Default\Cache" (
  set CACHE=%LOCALAPPDATA%\Google\Chrome\User Data\Default\Cache
  goto cache_ok
)
echo >&2 Error: Failed to find the Google Chrome cache.
goto :EOF
:cache_ok
:* dir "%CACHE%"
