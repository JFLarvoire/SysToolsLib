...
:#                                                                            *
:#  History:                                                                  *
:#   2024-01-07 JFL jf.larvoire@free.fr created this file from the one in C/. *
:#                                                                            *
...
if not defined STINCLUDE for /f "delims=" %%d in ('"pushd C\include & cd & popd"') do SET "STINCLUDE=%%d" &:# Default: Use the current directory
